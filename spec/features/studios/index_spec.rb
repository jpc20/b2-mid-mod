...
RSpec.describe "Studio Index" do
  it "user can see all studios and the name of their movies" do
    studio1 = Studio.create(name: "Funny Studio", location: "Hollywood")
    studio2 = Studio.create(name: "Action Studio", location: "LA")
    movie1 = studio1.movies.create(title: "Dumb n Dumber", year: "1999")
    movie2 = studio1.movies.create(title: "Austin Powers", year: "2001")
    movie3 = studio2.movies.create(title: "Mission Impossible", year: "2004")
    movie4 = studio2.movies.create(title: "The Bourne Identity", year: "2001")
    visit '/studios'
